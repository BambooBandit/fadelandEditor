 ...
 * @author mzechner
 * @author Nathan Sweet */
public class EditorSprite extends TextureRegion
{
    ...
    private float x, y, editorX, editorY;
    float width, height;
    ...
    public EditorSprite (int width, int height) {
    ...
    public EditorSprite (int srcX, int srcY, int srcWidth, int srcHeight) {
    ...
    public EditorSprite (TextureRegion region) {
        setRegion(region);
     ...
     * @param srcWidth The width of the texture region. May be negative to flip the sprite when drawn.
     * @param srcHeight The height of the texture region. May be negative to flip the sprite when drawn. */
    public EditorSprite (TextureRegion region, int srcX, int srcY, int srcWidth, int srcHeight) {
    ...
    public EditorSprite (Sprite sprite) {
        set(sprite);
    }
    ...
    public float[] getVertices () {
        if (dirty) {
            ...
            if (rotation != 0) {
                final float editorCos = MathUtils.cosDeg(rotation);
                final float editorSin = MathUtils.sinDeg(rotation);
                final float cos = MathUtils.cosDeg(rotation);
                final float sin = MathUtils.sinDeg(rotation);
                final float editorLocalXCos = localX * editorCos;
                final float editorLocalXSin = localX * editorSin;
                final float editorLocalYCos = localY * editorCos;
                final float editorLocalYSin = localY * editorSin;
                ...
                vertices[X1] = x1;
                vertices[Y1] = y1;
                editorX = editorLocalXCos - editorLocalYSin + worldOriginX;
                editorY = editorLocalYCos + editorLocalXSin + worldOriginY;
    ...
    public void setRegion (float u, float v, float u2, float v2) {
        ...
        float[] vertices = EditorSprite.this.vertices;
        vertices[U1] = u;
        vertices[V1] = v2;
